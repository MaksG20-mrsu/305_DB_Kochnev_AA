...
FILES = {"movies": os.path.join(DATASET_PATH, "movies.csv"),"ratings": os.path.join(DATASET_PATH, "ratings.csv"),"tags": os.path.join(DATASET_PATH, "tags.csv"),"users": os.path.join(DATASET_PATH, "users.txt"),}

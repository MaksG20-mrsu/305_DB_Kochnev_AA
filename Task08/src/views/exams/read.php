...
<body>
<h1>Экзамены студента: <?= htmlspecialchars($studentRecord['full_name']) ?></h1>
<a href="index.php?action=exam_create&student_id=<?= (int)$studentRecord['id'] ?>">Добавить экзамен</a>    <a href="index.php">Назад к списку</a>
            ...
            <?php else: ?>
                <?php foreach ($exams as $e): ?>
                    <tr>
                        ...
                        <td>
                            <a href="index.php?action=exam_edit&id=<?= $e['id'] ?>">Изменить</a>
